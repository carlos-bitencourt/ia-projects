...
Para realização da pesquisa, foram selecionadas cinco bases de dados disponíveis publicamente  relativas a Estimativas de Esforço de Software: Cocomo81, Cocomonasa, Desharnais, Nasanumeric e Seera \cite{promise:2005, nasanumeric:2014, seera:2020}.
