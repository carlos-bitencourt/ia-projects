...
Para realização da pesquisa, foram selecionadas cinco bases de dados disponíveis publicamente relativas a Estimativas de Esforço de Software: 

Foram selecionados cinco Algoritmos para análise de performance: Árvore de Decisão (DT), Redes Neurais Artificiais (Perceptron Multi-camadas - MLP), K-Vizinhos Mais Próximos (KNN), Máquinas de Vetor de Suporte (SVM) e Floresta Aleatório (RF).  \cite{scikitlearn:2011}
